...
class YoutubeOAuth {
  ...
  public function __construct() {
	...
	$CI =& get_instance();	
	$CI->config->load('youtubeoauth');
	global $consumer_key;
	$consumer_key = $CI->config->item('youtube_consumer_key');
  	$consumer_secret = $CI->config->item('youtube_consumer_secret');
 	$oauth_token = $CI->config->item('youtube_oauth_token');
  	$oauth_token_secret = $CI->config->item('youtube_oauth_token_secret');
  ...
  function getRequestToken() {
    ...
    $parameters['scope'] = "http://gdata.youtube.com";
  ...
  function getAuthorizeURL($token, $callback) {
    ...
    return $this->authorizeURL() . "?oauth_token={$token}&oauth_callback=".$callback;
  }
